---
title: 'Data evaluation for project: EDA social media and mental health'
...
Mental_Health_and_Social_Media_Balance_Dataset <- read_csv(here("Mental_Health_and_Social_Media_Balance_Dataset.csv"))
...
**Median**: It slightly differ between genders. Male and female groups have close central tendency values, while the Other group shows a noticeably lower median — but this should be interpreted cautiously due to the small sample size.
...
The correlation heatmap shows that screen time positively correlated with stress level. In other words, Increase in one indicates increase in the other. This does not imply cause and consequence relationship, just positive correlation.
